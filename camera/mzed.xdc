...
# ---------------------------------------------------------------------------- 
# Bank 34
set_property PACKAGE_PIN N12 [get_ports {reset     }];  # "N12.PMOD2_D1_N"
set_property PACKAGE_PIN N11 [get_ports {d_0[1]     }];  # "N11.PMOD2_D1_P"
set_property PACKAGE_PIN P14 [get_ports {d_0[3]     }];  # "P14.PMOD2_D0_N"
set_property PACKAGE_PIN P13 [get_ports {d_0[5]     }];  # "P13.PMOD2_D0_P"


set_property PACKAGE_PIN R13 [get_ports {pwdn     }];  # "R13.PMOD2_D3_N"
set_property PACKAGE_PIN R12 [get_ports {d_0[0]     }];  # "R12.PMOD2_D3_P"
set_property PACKAGE_PIN R15 [get_ports {d_0[2]     }];  # "R15.PMOD2_D2_N"
set_property PACKAGE_PIN P15 [get_ports {d_0[4]     }];  # "P15.PMOD2_D2_P"
...
# ---------------------------------------------------------------------------- 
# Bank 34
set_property PACKAGE_PIN M14 [get_ports {d_0[7]     }];  # "M14.PMOD1_D1_N"
set_property PACKAGE_PIN L14 [get_ports {pclk     }];  # "L14.PMOD1_D1_P" 
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets pclk]
set_property PACKAGE_PIN M15 [get_ports {vsync     }];  # "M15.PMOD1_D0_N"
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets vsync]
set_property PACKAGE_PIN L15 [get_ports {sioc     }];  # "L15.PMOD1_D0_P"


set_property PACKAGE_PIN N14 [get_ports {d_0[6]     }];  # "N14.PMOD1_D3_N"
set_property PACKAGE_PIN N13 [get_ports {xclk     }];  # "N13.PMOD1_D3_P"
set_property PACKAGE_PIN L13 [get_ports {href     }];  # "L13.PMOD1_D2_N"
set_property PACKAGE_PIN K13 [get_ports {siod     }];  # "K13.PMOD1_D2_P"
